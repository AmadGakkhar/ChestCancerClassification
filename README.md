...
6. Run the following commands on EC2 Machine
...
7. Open public IPv4 DNS to port 5000

8. Set uri in local terminal and in your code

9. export ML_FLOW_TRACKING_URI=http://ec2-3-142-248-17.us-east-2.compute.amazonaws.com:5000

10. update remote_server_uri in your code as well to see the tracking on aws server.
